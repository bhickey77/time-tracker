...
router.post('/', (req, res) => {
    let entry = req.body;
    console.log('handling POST for /entry', req.body);
...
router.get('/', (req, res) => {
    ...
    let queryText =    `SELECT entry.item, entry.item_date_milli_from_epoch, entry.entry_time_milliseconds, project.project_name FROM entry_project
